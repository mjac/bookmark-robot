define(function () {
    ...
    stopWords += ',';
    stopWords += 'web,website,site,net,welcome,blog,best,big,day,use,ways,way,org,file,magazine,uk,great,good,things,open,online,free,developer,developers,think,world,write';
